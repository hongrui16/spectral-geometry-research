"""E0/E2 (docs/unified_paper_document_v3.md §11 E2, §12.4): finite-step KL probe.
...
Usage (GPU):
  python analysis_v3/kl_probe.py --out results/v3/result_A/kl_probe_0.8b
...
from specgeom_v3.data import build_prompt, load_gsm8k
from specgeom_v3.instrument import select_tracked
...
def logp_batch(model, input_ids, attn, use_autocast):
    ...
    constant KL floor ~2e-4 nats/token (see results/v3/result_A/kl_probe_0.8b_bf16).
