...
| 文档 | 内容 | 维护人 |
|---|---|---|
| `docs/unified_paper_document_v3.md` | v3 企划书草案(2026-09-11 重写稿):开头为 v2 状况总账(成立/推翻/主线不成立);新主线 = 谱变化与遗忘的双重分离(只改谱不遗忘、精确保谱照样遗忘)+ 奇异基 ≈ 随机字典 + 自由度/推进量前沿;理论预测 §3.2(局部二次下累计 KL 与字典无关);E-v3-0…5 共 28 run 的设计、裁决规则、砍序与时间线。生效后 v2 冻结 | A |
