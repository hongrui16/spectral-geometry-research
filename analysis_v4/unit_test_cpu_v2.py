...
Run: ~/envs_spectral/bin/python analysis_v4/unit_test_cpu_v2.py
"""
...
from specgeom_v4 import metrics
from specgeom_v4.interventions import (MATCHED, project_update, random_basis)
...
def _fake_capture(run, intervention, B=8, planted="diag", seed=0):
    ...
    """
    from analysis_v4 import compute_metrics as cm
