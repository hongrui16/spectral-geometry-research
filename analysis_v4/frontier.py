...
Reads run directories (results/v4/result_B/<run>/ and results/v2/result_B/e4a_*),
...
Usage:
  python analysis_v4/frontier.py results/v4/result_B results/v2/result_B --out figs/v3
"""
